...
export const AIMessageContent = ({
  ...
  <div
    className={cn(
      "break-words",
      "border-border flex flex-col gap-2 rounded-lg border px-3 py-2 text-sm",
      "bg-background text-foreground",
      "group-[.is-user]:from-primary group-[.is-user]:text-primary-foreground group-[.is-user]:border-transparent group-[.is-user]:bg-gradient-to-b group-[.is-user]:to-[#0b63f3]",
      className,
    )}
    {...props}
  >
